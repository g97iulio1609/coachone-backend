 ...
 * Step dell'import
 */
export type ImportStep = 'validating' | 'parsing' | 'matching' | 'reviewing' | 'converting' | 'saving' | 'completed' | 'error';
/**
...
export declare class WorkoutImportService {
     ...
     */
    import(files: ImportFile[], userId: string, options?: Partial<ImportOptions>): Promise<ImportResult>;
    /**

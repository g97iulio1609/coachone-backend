 ...
 */
export declare function addDay(
  program: WorkoutProgram,
  weekNumber: number
): {
  program: WorkoutProgram;
 ...
 */
export declare function addExercise(
  program: WorkoutProgram,
  weekNumber: number,
  dayNumber: number,
  exercise?: Exercise
 ...
 */
export declare function removeExercise(
  program: WorkoutProgram,
  weekNumber: number,
  dayNumber: number,
  exerciseId: string
 ...
 */
export declare function updateExercise(
  program: WorkoutProgram,
  weekNumber: number,
  dayNumber: number,
  exerciseId: string,
 ...
 */
export declare function updateWeek(
  program: WorkoutProgram,
  weekNumber: number,
 ...
 */
export declare function addSetGroupToExercise(
  program: WorkoutProgram,
  weekNumber: number,
  dayNumber: number,
  exerciseId: string,
 ...
 *
 * Nota: mantiene la stessa semantica di `addSetGroupToExercise`, ma espone
 * un nome più coerente con l'uso nel Visual Builder e negli hook.
 */
 ...
 */
export declare function groupSelectedSets(
  program: WorkoutProgram,
  weekNumber: number,
  dayNumber: number,
  exerciseId: string,
 ...
 */
export declare function splitSetGroup(
  program: WorkoutProgram,
  weekNumber: number,
  dayNumber: number,
  exerciseId: string,
 ...
 */
export declare function removeSetGroup(
  program: WorkoutProgram,
  weekNumber: number,
  dayNumber: number,
  exerciseId: string,
 ...
 */
export declare function duplicateSetGroup(
  program: WorkoutProgram,
  weekNumber: number,
  dayNumber: number,
  exerciseId: string,

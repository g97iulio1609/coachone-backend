...
import { z } from 'zod';
export declare const exerciseImportSchema: z.ZodIntersection<
  z.ZodObject<
    {
...
export declare class ExerciseAdminService {
   ...
   */
  static exportAll(options?: { includeUnapproved?: boolean }): Promise<ExerciseExportRecord[]>;
  /**

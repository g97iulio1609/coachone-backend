...
export interface AgentConfig {
  id: string;
  feature: string; // The agent ID (e.g., 'exercise-generation')
  isEnabled: boolean;
  config: unknown;
...
export class AIConfigService {
   ...
   */
  static async getAgentConfig(agentId: string): Promise<AgentConfig | null> {
   ...
   */
  static async isAgentEnabled(agentId: string): Promise<boolean> {
   ...
   */
  static async ensureAgentConfig(
    agentId: string,
    description: string,

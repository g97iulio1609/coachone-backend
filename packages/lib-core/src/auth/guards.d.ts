...
export declare function requireAuth(): Promise<
  | import('./session').AuthenticatedUser
  | NextResponse<{
      error: string;
    }>
>;
 ...
 */
export declare function requireSuperAdmin(): Promise<
  | import('./session').AuthenticatedUser
  | NextResponse<{
      error: string;
    }>
 ...
 */
export declare function requireResourceAccess(resourceUserId: string): Promise<
  | import('./session').AuthenticatedUser
  | NextResponse<{
      error: string;
    }>
 ...
 */
export declare function withAdmin(
  handler: (req: Request, user: unknown) => Promise<Response>
): (req: Request) => Promise<Response>;
/**
 * Wrapper per API route con super admin guard
 */
export declare function withSuperAdmin(
  handler: (req: Request, user: unknown) => Promise<Response>
): (req: Request) => Promise<Response>;

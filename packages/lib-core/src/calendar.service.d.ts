 ...
 */
export declare function getCalendarAssignments(
  params: QueryCalendarAssignmentsRequest
): Promise<CalendarAssignment[]>;
/**
 * Get calendar assignment by ID
 */
export declare function getCalendarAssignmentById(
  id: string,
  userId: string
 ...
 */
export declare function updateCalendarAssignment(
  id: string,
  userId: string,
 ...
 */
export declare function deleteAssignmentsByPlanId(
  userId: string,
  planType: CalendarPlanType,
  planId: string
): Promise<number>;
 ...
 */
export declare function deleteAssignmentsInRange(
  userId: string,
  startDate: Date | string,
  endDate: Date | string,
  planType?: CalendarPlanType

 ...
 */
export async function seedFeatureFlags(prisma, adminUserId) {
    ...
    const invitationRegistrationFlag = await prisma.feature_flags.upsert({
        ...
        create: {
            ...
            description: 'Abilita o disabilita la possibilità di registrarsi utilizzando un codice invito. Quando disabilitato, il campo invito non sarà visibile nel form di registrazione.',

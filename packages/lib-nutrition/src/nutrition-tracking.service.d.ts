 ...
 */
export declare function createNutritionDayLog(
  userId: string,
 ...
 */
export declare function getNutritionDayLog(
  logId: string,
  userId: string
 ...
 */
export declare function getNutritionDayLogs(
  userId: string,
  planId?: string,
  limit?: number
): Promise<NutritionDayLog[]>;
 ...
 */
export declare function getLogForDay(
  userId: string,
  planId: string,
  weekNumber: number,
  dayNumber: number,
 ...
 */
export declare function updateNutritionDayLog(
  logId: string,
  userId: string,
 ...
 */
export declare function getNutritionPlanStats(
  planId: string,
  userId: string

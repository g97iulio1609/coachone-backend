 ...
 * @returns Prisma.InputJsonValue for use in Prisma create/update operations
 */
export declare function toPrismaJsonWeeks(
  weeks:
    | NutritionWeek[]
    | Array<{
        weekNumber: number;
...
export declare function toPrismaJsonPersonalizedPlan(
  plan: PersonalizedPlan | null
): Prisma.NullableJsonNullValueInput;
export declare function toPrismaJsonAdaptations(
  adaptations: Adaptations | null
): Prisma.NullableJsonNullValueInput;
export declare function toPrismaJsonUserProfile(
 ...
 */
export declare function toPrismaJsonMetadata(

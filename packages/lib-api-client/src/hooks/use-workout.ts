...
export function useCreateWorkout() {
  ...
  return useMutation({
    mutationFn: (data: unknown) => workoutApi.create(data),
    onSuccess: () => {
...
export function useUpdateWorkout() {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: unknown }) => workoutApi.update(id, data),
...
export function useCreateWorkoutSession() {
  ...
  return useMutation({
    ...
    }) => workoutApi.createSession(programId, data),
    onSuccess: () => {
...
export function useUpdateWorkoutSession() {
  ...
  return useMutation({
    mutationFn: ({ sessionId, data }: { sessionId: string; data: unknown }) =>
      workoutApi.updateSession(sessionId, data),
    onSuccess: (_, variables) => {

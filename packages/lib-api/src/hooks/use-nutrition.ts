 ...
 */
export function useNutritionPlanVersions(id: string | null | undefined) {
  return useQuery({
 ...
 */
export function useNutritionDayLog(logId: string | null | undefined) {
  return useQuery({
...
export function useCreateNutritionPlan() {
  ...
  return useMutation({
    mutationFn: (data: unknown) => nutritionApi.create(data),
    onSuccess: () => {
...
export function useUpdateNutritionPlan() {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: unknown }) => nutritionApi.update(id, data),
...
export function useCreateNutritionDayLog() {
  ...
  return useMutation({
    ...
    }) => nutritionApi.createDayLog(planId, data),
    onSuccess: () => {
...
export function useUpdateNutritionDayLog() {
  ...
  return useMutation({
    mutationFn: ({ logId, data }: { logId: string; data: unknown }) =>
      nutritionApi.updateDayLog(logId, data),
    onSuccess: (_, variables) => {

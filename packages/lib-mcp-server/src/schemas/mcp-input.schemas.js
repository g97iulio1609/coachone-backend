 ...
 */
import { z } from 'zod';
import { MacrosSchema as BaseMacrosSchema, CompleteMacrosSchema as BaseCompleteMacrosSchema, NutritionUserProfileSchema, FoodSchema as BaseFoodSchema, MealSchema as BaseMealSchema, NutritionDaySchema as BaseNutritionDaySchema, NutritionWeekSchema as BaseNutritionWeekSchema, exerciseSetSchema, setProgressionSchema, setGroupSchema, exerciseSchema, workoutDaySchema, workoutWeekSchema, } from '@onecoach/schemas';
// ============================================================================
// BASE SCHEMAS
// ============================================================================
 ...
 */
export function validateNutritionPlan(data) {
...
export const AIOutputNutritionPlanSchema = NutritionPlanInputSchema.extend({
    ...
    weeks: z
        .array(NutritionWeekSchema.extend({
        id: z.string().optional(),
        days: z.array(NutritionDaySchema.extend({
            id: z.string().optional(),
    ...
    metadata: z
        ...
        .optional()
        .describe('Optional metadata about AI decisions (methodology, calculations, etc.) - for transparency only'),
}).passthrough();
/**
...
export const AIOutputWorkoutProgramSchema = WorkoutProgramInputSchema.extend({
    // Override some fields to be more lenient for AI output
    weeks: z
        .array(WorkoutWeekSchema.extend({
        days: z.array(WorkoutDaySchema.extend({
            exercises: z.array(ExerciseSchema.extend({
                ...
                name: z.string().optional(),
                setGroups: z.array(SetGroupSchema.extend({
                    id: z.string().optional(),
    ...
    metadata: z
        .record(z.string(), z.unknown())
        .optional()
        .describe('Optional metadata about AI decisions (split type, periodization, progression strategy, etc.) - for transparency only'),
}).passthrough();

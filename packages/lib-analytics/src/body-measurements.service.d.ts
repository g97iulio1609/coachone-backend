...
export declare function createBodyMeasurement(
  userId: string,
  data: CreateBodyMeasurementInput
): Promise<BodyMeasurement>;
export declare function getBodyMeasurement(
  userId: string,
  date: Date
): Promise<BodyMeasurement | null>;
export declare function getBodyMeasurementById(
  measurementId: string,
  userId: string
): Promise<BodyMeasurement | null>;
export declare function getBodyMeasurementHistory(
  userId: string,
  startDate?: Date,
  endDate?: Date,
  limit?: number
...
export declare function updateBodyMeasurement(
  measurementId: string,
  userId: string,
...
export declare function getBodyMeasurementStats(
  userId: string,
  startDate: Date,
  endDate: Date
): Promise<{

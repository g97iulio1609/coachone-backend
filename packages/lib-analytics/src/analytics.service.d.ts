...
export declare function getBodyMetricsChange(
  userId: string,
  startDate: Date,
  endDate: Date
): Promise<{
...
export declare function getWorkoutVolumeTimeSeries(
  userId: string,
  startDate: Date,
  endDate: Date
): Promise<TimeSeriesDataPoint[]>;
export declare function getStrengthProgress(
  userId: string,
  exerciseId: string,
  startDate: Date,
  endDate: Date
...
export declare function calculateWorkoutMetrics(
  userId: string,
  startDate: Date,
  endDate: Date
): Promise<{
...
export declare function calculateNutritionAdherence(
  userId: string,
  planId: string,
  weekNumber: number
): Promise<{
...
export declare function getNutritionMacrosTimeSeries(
  userId: string,
  planId: string,
...
export declare function generateAnalyticsReport(
  userId: string,
  startDate: Date,
  endDate: Date
): Promise<UserAnalyticsReport>;
export declare function getUserGoals(userId: string): Promise<UserGoal[]>;
export declare function createUserGoal(
  userId: string,
  goal: Omit<UserGoal, 'id' | 'userId' | 'createdAt' | 'updatedAt'>
): Promise<UserGoal>;
export declare function generateWeightChart(
  userId: string,
  startDate: Date,
  endDate: Date
): Promise<AnalyticsChartData>;
export declare function generateVolumeChart(
  userId: string,
  startDate: Date,
  endDate: Date
): Promise<AnalyticsChartData>;
export declare function generateMacrosChart(
  userId: string,
  planId: string,
  startDate: Date,
  endDate: Date
